...
export function DashboardTab() {
  ...
  const totalsalesData: ChartData<'doughnut'> = {
  ...
  const pizzassalesData: ChartData<'pie', number[], string> = {
    labels: ['Pizza de Calabresa', 'Pizza de Frango', 'Pizza de Portuguesa', 'Pizza de Marguerita'],
    datasets: [{
      data: [45, 25, 15, 25],
      backgroundColor: [
        'rgba(206, 55, 45, 0.7)',
  ...
  return (
    <div className="space-y-6">
      <h2 className="text-2xl text-white font-bold">Dashboard Geral</h2>
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div className="bg-[var(--color-bg-tertiary)] text-white p-4 rounded-lg shadow">
          <h3 className="text-lg font-semibold mb-4">Pizzas mais Vendidas</h3>
          <div className="h-auto">
            <Pie data={pizzassalesData} options={pieOptions} />
          </div>
        </div>
        <div className="bg-[var(--color-bg-tertiary)] text-white p-4 rounded-lg shadow">
          <h3 className="text-lg font-semibold mb-4">Saldo total</h3>
          <div className="h-auto">
